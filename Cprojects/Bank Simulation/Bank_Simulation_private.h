...
#ifndef Bank_Simulation_private_rc
#define Bank_Simulation_private_rc
...
#define ORIGINAL_FILENAME	"Bank Simulation.exe"
#define PRODUCT_NAME	"Bank Simulation"
#define PRODUCT_VERSION	"0.1.1.1"

#endif /*Bank_Simulation_private_rc*/
